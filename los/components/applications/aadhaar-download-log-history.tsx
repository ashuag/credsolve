          ...
          <tbody>
            {logs.map((row, index) => (
              ...
              >
                ...
                <td className="border-b border-[rgba(15,39,72,0.06)] px-3 py-2.5 font-mono font-bold text-brand-navy whitespace-nowrap">
                  {row.httpStatus ?? '—'}
                </td>
                ...
                <td className="border-b border-[rgba(15,39,72,0.06)] px-3 py-2.5 whitespace-nowrap">
                  <button
                    ...
                    className="cursor-pointer rounded-[8px] border border-[rgba(15,39,72,0.12)] bg-white px-2.5 py-1 text-[0.72rem] font-extrabold uppercase tracking-[0.06em] text-brand-blue"
                  >
                    View
                  </button>
                </td>
