...
exports.seedEligibilityCriteria = seedEligibilityCriteria;
const CRITERIA = [
...
async function seedEligibilityCriteria(prisma) {
    for (const c of CRITERIA) {
        await prisma.$executeRaw `
      INSERT INTO \`eligibility_criteria\` (key, label, value, description, is_active)
      VALUES (${c.key}, ${c.label}, ${c.value}, ${c.description}, 1)
