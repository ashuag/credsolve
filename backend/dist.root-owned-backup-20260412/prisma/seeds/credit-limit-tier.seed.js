...
exports.seedCreditLimitTier = seedCreditLimitTier;
...
async function seedCreditLimitTier(prisma) {
    ...
    for (const t of TIERS) {
      ...
      INSERT INTO \`credit_limit_tier\`
        (min_unsecured_loan, max_unsecured_loan, max_bullet_loan, sort_order, is_active)
      VALUES
        (${t.minUnsecuredLoan}, ${t.maxUnsecuredLoan}, ${t.maxBulletLoan}, ${t.sortOrder}, 1)
    `;
    }
