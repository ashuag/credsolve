...
const TRIGGER_CLASS =
  'inline-flex items-center justify-center gap-2 min-h-[42px] min-w-0 max-w-[min(280px,calc(100vw-6rem))] pl-5 pr-4 py-2.5 rounded-full font-extrabold text-[0.92rem] sm:text-[0.96rem] text-[#ecfdf5] bg-[linear-gradient(135deg,#1c347d_0%,#12244f_100%)] shadow-[0_12px_28px_rgba(23,44,113,0.25)] transition-[transform,box-shadow] duration-200 hover:-translate-y-0.5 hover:shadow-[0_16px_36px_rgba(23,44,113,0.35)]';
