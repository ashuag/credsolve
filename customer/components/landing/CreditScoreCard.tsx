          ...
          <div className="mc-card border-[rgba(18,36,79,0.06)] bg-[#f8fbff]/50 p-10">
            ...
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
              {[
                ...
                { title: 'Safe & Secure', desc: 'Bank-grade security • Encrypted transactions', icon: 'M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z' },
